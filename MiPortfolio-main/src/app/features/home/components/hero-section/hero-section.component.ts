...
.hero__desktop-vector {
  ...
  z-index: 1 !important;
  transform: rotate(-4deg) perspective(151px) rotateX(117deg) !important;
  overflow: visible !important;
    ...
    .hero__desktop-vector-image {
      ...
      clip-path: ellipse(100% 60% at 50% 100%) !important;
      transform: perspective(150px) rotateX(50deg) scale(1.5) translateY(-50px) !important;
